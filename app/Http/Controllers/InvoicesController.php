...
//        Notification::send($user, new \App\Notifications\InvoicePaid($invoices));
    ...
    public function show_Paid_bills(invoices $invoices)
    {
        $invoices = invoices::all()->where('Value_Status', '1');
        return view('invoices.Paid_bills', compact('invoices'));
    }

    public function show_Unpaid_bills(invoices $invoices)
    {
        $invoices = invoices::all()->where('Value_Status', '2');
        return view('invoices.Paid_bills', compact('invoices'));
    }

    public function Partially_paid_bills(invoices $invoices)
    {
        $invoices = invoices::all()->where('Value_Status', '3');
        return view('invoices.Paid_bills', compact('invoices'));
    }
